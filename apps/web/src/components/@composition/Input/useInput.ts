...
export const useInput = () => {
	...
	const inputClass = tv({
		base: `block bg-transparent w-full rounded-md py-1.5 text-white border-none ring-1 ring-inset ring-gray-500 hover:ring-primary placeholder:text-muted-foreground focus:ring-2 focus:ring-primary sm:text-sm sm:leading-6 ${
